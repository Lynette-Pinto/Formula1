...
# MAGIC %md
# MAGIC ### Mount Azure Data Lake containers for this project
# MAGIC
...
mount_adls('formula1dllwp','raw')

# COMMAND ----------

mount_adls('formula1dllwp','processed')

# COMMAND ----------

mount_adls('formula1dllwp','presentation')
